...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err?.response?.data?.detail || 'Kirishda xatolik yuz berdi. Parolni tekshiring yoki qayta urinib ko\'ring.');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleDemoLogin = async () => {
    ...
    try {
      ...
      setError(err?.response?.data?.detail || 'Demo tizimga kirishda xatolik.');
    } finally {
      setIsLoading(false);
    }
  };
